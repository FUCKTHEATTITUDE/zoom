...
def start(name, proxy, user, wait_time):
    ...
    time.sleep(3)
    inp = driver.find_element_by_xpath('//*[@id="inputname"]')
    time.sleep(1)
    inp.send_keys(f"{user}")
    btn2 = driver.find_element_by_xpath('//*[@id="joinBtn"]')
    btn2.click()
    time.sleep(2)
    inp2 = find_element_by_xpath('//*[@id="inputpasscode"]')
    time.sleep(1)
    inp2.send_keys(passcode)
    btn3 = driver.find_element_by_xpath('//*[@id="joinBtn"]')
    time.sleep(1)
    btn3.click()
